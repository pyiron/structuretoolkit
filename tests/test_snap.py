...
class TestSNAP(unittest.TestCase):
    ...
    def test_get_descriptor_name(self):
        ...
        names = stk.analyse.get_snap_descriptor_names(twojmax=self.twojmax)
    ...
    def test_calc_bispectrum_lmp_quad(self):
        ...
        self.assertEqual(
            coeff.shape, (len(self.structure), ((n_coeff + 1) * n_coeff) / 2 + 30)
        )
        self.assertTrue(
            np.isclose(
                np.array(coeff),
...
class TestSNAPInternal(unittest.TestCase):
    ...
    def test_calc_bispectrum_lmp_quad(self):
        ...
        self.assertEqual(
            coeff_quad.shape, (len(self.structure), ((n_coeff + 1) * n_coeff) / 2 + 30)
        )
