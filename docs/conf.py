...
project = 'structuretoolkit'
copyright = u'2023, Max-Planck-Institut für Eisenforschung GmbH - Computational Materials Design (CM) Department ' \
...
main(['-e', '-o', 'apidoc', '../structuretoolkit', '--force'])
